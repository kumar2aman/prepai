...
function Stats() {
  const stats = [
    { label: "Total Score", value: "950", icon: TrendingUp, color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20" },
    { label: "Level", value: "5", icon: Star, color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20" },
