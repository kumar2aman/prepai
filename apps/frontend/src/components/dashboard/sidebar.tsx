...
function Sidebar() {
  return (
     <div className="border-r border-orange-400">
        <aside className="w-60 min-h-screen text-white p-4 flex flex-col justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white mb-8">PrepAI</h1>
            <nav className="space-y-4">
              <button className="w-full text-left px-4 py-2 bg-orange-500 rounded-md font-semibold">Dashboard</button>
